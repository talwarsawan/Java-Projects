 ...
 */
public class testingQuiz extends javax.swing.JFrame {

    /**
     * Creates new form testingQuiz
     */
...
{       
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(testingQuiz.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new testingQuiz().setVisible(true);
            }
        });
    }
