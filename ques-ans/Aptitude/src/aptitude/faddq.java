 ...
 */
public class faddq extends javax.swing.JFrame {

    /**
     * Creates new form faddq
     */
    public faddq() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setLocation(new java.awt.Point(250, 133));
        setResizable(false);
     ...
     try
{
    ...
    String q="insert into tbques(qname,cid,lid,a,b,c,d,correct,solution)values(?,?,?,?,?,?,?,?,?)";
...
catch(Exception e)
{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(faddq.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
